    ...
    <section class="relative isolate overflow-hidden bg-ink py-20 sm:py-28">
      ...
      <div class="mx-auto grid max-w-7xl gap-12 px-6 lg:grid-cols-[1.15fr_.85fr] lg:items-end">
        <div class="max-w-2xl text-white">
          <div
            class="mb-5 inline-flex items-center gap-2 rounded-full border border-white/20 bg-white/10 px-3 py-1.5 font-mono text-[11px] uppercase tracking-[0.16em] text-amber"
          >
            <span class="h-1.5 w-1.5 rounded-full bg-amber" /> ETEC Center Digital Library
          </div>
          <h1 class="font-display text-5xl leading-[0.98] tracking-[-0.03em] sm:text-7xl">
            Knowledge that moves<br />with your ambition.
          </h1>
          <p class="mt-6 max-w-xl text-base leading-8 text-white/70 sm:text-lg">
            ETEC-LIBRARY brings useful books, fresh ideas, and study-ready resources together in one
            calm place for every learner.
          </p>
          <form
            class="mt-9 flex max-w-xl flex-col gap-2 rounded-2xl border border-white/20 bg-white p-2 shadow-2xl sm:flex-row"
            @submit.prevent="onSearch"
          >
            <div class="flex flex-1 items-center gap-3 px-3">
              <svg class="text-ink-soft" width="20" height="20" viewBox="0 0 24 24" fill="none">
            ...
            <button
              type="submit"
              class="rounded-xl bg-amber px-6 py-3 text-sm font-extrabold text-ink transition hover:bg-amber-deep hover:text-white"
            >
              Explore books
            </button>
          </form>
          <div class="mt-10 flex gap-8 text-sm text-white/70">
            <span
        ...
        <div
          class="hidden rounded-3xl border border-white/15 bg-white/10 p-6 backdrop-blur md:block"
        >
          ...
          <NuxtLink
            ...
            class="mt-5 block overflow-hidden rounded-2xl bg-white text-ink"
            ><BookCoverImage
    ...
    <section class="mx-auto max-w-7xl px-6 py-16">
      ...
      <div class="mt-8 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <NuxtLink
          ...
          class="group rounded-2xl border border-line bg-white p-5 transition hover:-translate-y-1 hover:shadow-card"
          ><div class="flex items-center justify-between">
            <span
              ...
              ><svg width="21" height="21" viewBox="0 0 24 24" fill="none">
                ...
                /></svg></span
            ><span class="text-lg text-ink-soft transition group-hover:translate-x-1">→</span>
          </div>
    ...
    <section class="bg-parchment-dim py-16">
      <div class="mx-auto max-w-7xl px-6">
        <div class="flex flex-wrap items-end justify-between gap-4">
          ...
          <NuxtLink
            to="/products"
            class="rounded-xl bg-ink px-5 py-3 text-sm font-semibold text-white hover:bg-ink-light"
    ...
    <section class="mx-auto max-w-7xl px-6 py-16">
      <div class="grid overflow-hidden rounded-3xl bg-[#DDE9E2]">
        <div class="p-8 sm:p-12">
          ...
          <NuxtLink
            to="/about"
            class="mt-7 inline-flex rounded-xl border border-ink px-5 py-3 text-sm font-semibold text-ink transition hover:bg-ink hover:text-white"
            >Discover ETEC-LIBRARY</NuxtLink
          >
        </div>
      </div>
    </section>
